...
import logoCTD from '../assets/logoCTD.gif';
    ...
    <div className = "contineNavBar"> 
        <div className="phone_dropDownNavbarDiv">
            ...
            <div className="phone_NavBar">
                ...
                <div className = "phone_dropDownHead">
                    <Link to="/probleme" style={{textDecoration: 'none'}}> 
                ...
                <div className = "phone_dropDownHead">
                    <Link to="/istoria programarii" style={{textDecoration: 'none', marginLeft: '-20px'}} > 
            ...
            <div className = {`${activeTheme}MyNavbar MyNavbar`}>
                <div className = "dropdownHead" >
                    <Link to="/" style={{textDecoration: 'none'}}> <img src={logoCTD} alt='InfoCitadel' style={{width:'178px',height:'55px', marginTop: '-15px'}}/></Link>
                </div>
                <div className = "otherNavbarElements">
                    <div className = "dropdownHead">
                        <Link to="/probleme" style={{textDecoration: 'none'}}> Probleme</Link>
                    </div>
                    <div className = "dropdownHead">
                    ...
                    <div className = "dropdownHead"> 
                        <Link to="/istoria programarii" style={{textDecoration: 'none'}}> ProgHistory</Link>
                    </div>
                    <div className = "dropdownHead"> 
            ...
            {viewSignin && <CloseIcon onClick={handleSigninClick} style={{right: '345', top: '85', position: 'absolute', zIndex:'100', cursor: 'pointer', animation: 'slideIn 1s ease-in-out'}}/>}
